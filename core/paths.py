...
# 项目根目录  D:\pythoncharm\pythonProject\atguigu-shopkeeper\knowledge
KNOWLEDGE_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))

# 本地文件存储基础目录     D:\pythoncharm\pythonProject\atguigu-shopkeeper\knowledge\temp_data
LOCAL_BASE_DIR = os.path.join(KNOWLEDGE_ROOT, "temp_data")

# 前端页面静态资源目录     D:\pythoncharm\pythonProject\atguigu-shopkeeper\knowledge\front
