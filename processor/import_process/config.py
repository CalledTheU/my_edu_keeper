...
class ImportConfig:
    ...
    default_model: str = field(
        default_factory=lambda: os.getenv("LLM_DEFAULT_MODEL", "deepseek-v4-flash")
    )
    ...
    # 兼容旧节点：原 openai_* 字段现在代表主模型 DeepSeek。
    openai_api_base: str = field(
        default_factory=lambda: os.getenv(
            "DEEPSEEK_API_BASE", os.getenv("OPENAI_API_BASE", "https://api.deepseek.com")
        )
    )
